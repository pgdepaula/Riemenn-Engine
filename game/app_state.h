...
#ifndef RI_SRC_APP_STATE_H
#define RI_SRC_APP_STATE_H

#include <stdbool.h>
#include "engine/scene/scene.h"
#include "engine/rhi/rhi.h"
#include "engine/ui/ui.h"
#include "game/simulation/data/orbit_marker.h" /* [NOVO] Sistema de marcadores */
...
struct app_state {
	/* ---- Subsistemas ---- */
	ri_ui_ctx_t ui;   /* gui: Janela, GPU, Input */
	ri_scene_t scene; /* Engine: ECS, Physics, Bodies */

	/* ---- Assets de Rendering ---- */
	ri_gpu_texture_t bg_tex;     /* Textura do skybox */
	ri_gpu_texture_t sphere_tex; /* Impostor de esfera (fallback) */
	...
	/* ---- Compute Passes ---- */
	struct ri_blackhole_pass *bh_pass;  /* [NOVO] Handle opaco */
	struct ri_planet_pass *planet_pass; /* [NOVO] Renderizador 3D */

	/* ---- Estado da Câmera ---- */
	ri_camera_t camera; /* Posição, rotação, FOV */
	...
	/* ---- Estado de UI ---- */
	ri_hud_state_t hud; /* HUD: menus, seleção, etc */

	/* ---- [NOVO] Sistema de Marcadores de Órbita ---- */
	struct ri_orbit_marker_system orbit_markers;
