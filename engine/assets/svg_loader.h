#ifndef RI_ASSETS_SVG_LOADER_H
#define RI_ASSETS_SVG_LOADER_H

#include "image_loader.h" /* Para ri_image_t */
...
typedef struct ri_path ri_path_t;
...
struct ri_shape {
	...
	ri_path_t *paths;
	struct ri_shape *next;
};
typedef struct ri_shape ri_shape_t;
...
typedef struct ri_svg ri_svg_t;
 ...
 * @return Imagem RGBA (ri_image_t) alocada. Deve ser liberada com ri_image_free.
 */
