...
double ri_kerr_omega_frame(const struct ri_kerr *bh, double r, double theta)
{
   ...
   */
	...
	double a2 = a * a;
	double sum = r2 + a2;
	double Delta = ri_kerr_Delta(bh, r);
...
double ri_kerr_redshift_zamo(const struct ri_kerr *bh, double r, double theta)
{
	/*
   ...
   */
	...
	ri_kerr_metric_inverse(bh, r, theta, &g_inv);
